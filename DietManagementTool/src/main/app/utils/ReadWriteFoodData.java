...
import main.app.model.Food;
import main.app.model.Meal;
...
public class ReadWriteFoodData {
    ...
    */
    ...
    public ReadWriteFoodData(String username) {
        ...
        File userFile = new File(dataDir, username + ".csv");
        this.dataPath = userFile.getPath();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(dataPath))) {
            ...
            while ((line = br.readLine()) != null)//loops for every line
            {
                ...
                if (currentType == newType && currentDate.equals(newDate)) {
                    proxyFood = new Food(data[2], Double.parseDouble(data[3]), Double.parseDouble(data[4]), Double.parseDouble(data[5]), Double.parseDouble(data[6]), Double.parseDouble(data[7]), Double.parseDouble(data[8]), Double.parseDouble(data[9]), Double.parseDouble(data[10]), Double.parseDouble(data[11]), Double.parseDouble(data[12]), Double.parseDouble(data[13]));
